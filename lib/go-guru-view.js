...
class GuruView {
  ...
  createDescribeNode (mode, jsonObj) {
    ...
    if (jsonObj[jsonObj.detail].objpos) {
      root.appendChild(this.createLinkNode(jsonObj[jsonObj.detail].objpos))
    } else if (jsonObj[jsonObj.detail].namepos) {
      root.appendChild(this.createLinkNode(jsonObj[jsonObj.detail].namepos))
    }
  ...
  createMemberNode (members) {
    ...
    for (let member of members) {
      ...
      if (member.pos) {
        memberElement.appendChild(this.createLinkNode(member.pos))
      }
